...
const assistant_service_1 = require("../src/assistant/assistant.service");
const catalogue_service_1 = require("../src/catalogue/catalogue.service");
const deterministic_filter_service_1 = require("../src/assistant/deterministic-filter.service");
const bedrock_service_1 = require("../src/assistant/bedrock.service");
describe('AssistantService', () => {
    ...
    let bedrockService;
    beforeEach(() => {
        catalogueService = new catalogue_service_1.CatalogueService();
        catalogueService.onModuleInit();
        filterService = new deterministic_filter_service_1.DeterministicFilterService();
        bedrockService = new bedrock_service_1.BedrockService();
        assistantService = new assistant_service_1.AssistantService(catalogueService, filterService, bedrockService);
    });
